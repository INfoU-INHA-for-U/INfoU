        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(17*fem, 16*fem, 17*fem, 15*fem),
              width: double.infinity,
              decoration: BoxDecoration (
                color: Color(0xffffffff),
              ),
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(22.58*fem, 14.58*fem, 230*fem, 13.58*fem),
              width: double.infinity,
              decoration: BoxDecoration (
            ...
            Container(
              // group40Z3T (2:566)
              padding: EdgeInsets.fromLTRB(18.1*fem, 22*fem, 18.1*fem, 23*fem),
              width: 361*fem,
              decoration: BoxDecoration (
                color: Color(0xfff7f7f7),
              ),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // V5X (2:570)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 207.9*fem, 0*fem),
                                child: Text(
                                  '📚 시간표 사진 등록하기',
                                  style: SafeGoogleFont (
                                    'Inter',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // eMj (2:571)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 215.7*fem, 0*fem),
                                child: Text(
                                  '💸 내 포인트 조회하기',
                                  style: SafeGoogleFont (
                                    'Inter',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // em3 (2:572)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 189.7*fem, 0*fem),
                                child: Text(
                                  '📚 리뷰 남기고 포인트 받기',
                                  style: SafeGoogleFont (
                                    'Inter',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // 3HP (2:573)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 233.7*fem, 0*fem),
                                child: Text(
                                  '👛 이용권 구매하기',
                                  style: SafeGoogleFont (
                                    'Inter',
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(19*fem, 20.66*fem, 17*fem, 50*fem),
                    width: 360*fem,
                    decoration: BoxDecoration (
                      color: Color(0xfff7f7f7),
                    ),
                    child: Column(
                      ...
                      children: [
                        Container(
                          // 8CM (2:561)
                          margin: EdgeInsets.fromLTRB(0.06*fem, 0*fem, 0*fem, 32.34*fem),
                          child: Text(
                            '이용 안내',
                            style: SafeGoogleFont (
                              'Inter',
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 8*fem, 27.32*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 27.32*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // yMP (2:557)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 279*fem, 0*fem),
                                child: Text(
                                  '문의하기',
                                  style: SafeGoogleFont (
                                    'Inter',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                // MmF (2:559)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 240*fem, 0.04*fem),
                                child: Text(
                                  '개인정보 처리방침',
                                  style: SafeGoogleFont (
                                    'Inter',
