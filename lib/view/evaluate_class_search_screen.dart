...
class evaluate_class_search_screen extends StatefulWidget {

  final List<Lecture> lecture_list;
  final String input_name;

  const evaluate_class_search_screen(
      {Key? key, required this.lecture_list, required this.input_name})
      : super(key: key);

  @override
  State<evaluate_class_search_screen> createState() =>
      _evaluate_class_search_screenState();
}

class _evaluate_class_search_screenState
    extends State<evaluate_class_search_screen> {

  late List<Lecture> _lecture_list;

  //강의명 검색 data 후처리 함수
  List<Lecture> lecture_class_list_check(List<Lecture> lecture_list, String input_name) {
  ...
  Widget _evaluate_class_search_screen_infou_list_widget(int index, Lecture _one_lecture_list) {
      ...
      children: [
        ...
        Container(
            ...
            child: ListView.separated(
                ...
                itemBuilder: (context, index) => _evaluate_class_search_screen_infou_list_widget(index, _lecture_list[index]),
