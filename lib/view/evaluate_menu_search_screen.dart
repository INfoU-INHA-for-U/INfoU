...
class evaluate_menu_search_screen extends StatefulWidget {
  ...
  const evaluate_menu_search_screen(
      {Key? key, required this.lecture_list, required this.input_name, required this.selected_menu_index})
      : super(key: key);
...
class _evaluate_menu_search_screenState
  ...
  Widget _evaluate_menu_search_screen_infou_list_widget(int index, Lecture _one_lecture_list) {
