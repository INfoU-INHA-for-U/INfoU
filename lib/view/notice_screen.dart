...
class _notice_screenState extends State<notice_screen> {
  ...
  final Map<String, Map<String, String>> _noticeData = {
    ...
    '1': {
      'title': '[한국장학재단 학자금대출] 2024년 1학기 학자금대출 안내',
      'category': '장학 💰',
      'link': "http://www.naver.com",
    },
    '2': {
      'title': '[프런티어학부대학] 2024-1 기초교양필수 교과목 TA2 모집',
      'category': '모집 🤗',
      'link': "http://www.naver.com",
    },
  };
  ...
  final Map<String, Map<String, String>> _SimilarNoticeData = {
    '0': {
      'title': '[현장실습] 2024-1학기 (주)비욘드마케팅그룹 채용연계형 표준 현장실습 참여 학생 모집',
      'category': '인턴십 💼',
      'link': "http://www.naver.com",
    },
    '1': {
      'title': '[현장실습] 2024-1학기 (주)옵티마이저 현장실습학기제 참여 학생 모집',
      'category': '인턴십 💼',
      'link': "http://www.naver.com",
    },
    '2': {
      'title': '[의류미술대학] 2024-1학기 기초 미술 교육교과목 참여학생 모집',
      'category': '모집 🤗',
      'link': "http://www.naver.com",
    },
  };
...
class noticeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: MediaQuery.of(context).size.width * 0.9,
      padding: const EdgeInsets.only(left: 8, top: 15, right: 0.99),
      decoration: ShapeDecoration(
        color: Colors.white,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10),
